...
<!-- 
    ...
    *
    * schematron rules version 5.2.0
    */
-->
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern>        
        ...
        <sch:rule context="gmi:MI_Metadata">            
            ...
            <sch:assert test="starts-with(gmd:fileIdentifier/*/text(),'urn:SDN:CSR:')">fileIdentifier does not start with urn:SDN:CSR:</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmi:MI_Metadata">            
            ...
            <sch:assert test="gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue='series'">hierarchyLevel is not "series"</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        ...
        <sch:rule context="gmi:MI_Metadata">            
            ...
            <sch:assert test="gmd:hierarchyLevelName/sdn:SDN_HierarchyLevelNameCode/@codeListValue='CSR'">hierarchyLevelName is not "Cruise Summary record"</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmi:MI_MetadataExtensionInformation">            
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification">            
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmi:MI_Metadata/gmd:contact/gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode">            
